...
def txtLabel_to_xmlLabel(source_txt_path,save_xml_path):
    if not os.path.exists(save_xml_path):
        os.makedirs(save_xml_path)
    # classes = ['human', 'elephant', 'lion', 'giraffe','jj']
    classes = ['uav']
    print(classes)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_txt_path', type=str, default="/data/dl_2080/SPSR-master/newdataset/靶场无人机序列5_txt")
    parser.add_argument('--save_xml_path', type=str, default="/data/dl_2080/SPSR-master/newdataset/靶场无人机序列5_XML_LR")
    opt = parser.parse_args()

    txtLabel_to_xmlLabel(opt.source_txt_path,opt.save_xml_path)